...
namespace VulkanTriangle
{
	...
	{
		typealias RenderCallback = delegate void();
		typealias MainLoopExitCallback = delegate void();
		...
		private void InitWindow(){
			...
			String title = scope String("Vulkan Triangle");
		...
		private void MainLoop(RenderCallback renderCallback, MainLoopExitCallback loopExitCallback)
		{
			bool running = true;
